  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="registerRules" class="login-form" auto-complete="on"
      ...
      <el-form-item prop="password">
        ...
        <el-input ref="password" v-model="loginForm.password" placeholder="Password" name="password" type="text"
          tabindex="1" auto-complete="on" />
      </el-form-item>

      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;"
        @click="login('loginForm')">点击登录</el-button>
            ...
            this.$axios.post('/api/user/login', {
              ...
              .then((response) => {
                  ...
                  if(data.code === 1){
                     ...
                     //将token保存到本地，访问api的时候自动在header里面带上
